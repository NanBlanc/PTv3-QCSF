...
# scheduler settings
epoch = 600 #for n=500
eval_epoch=10 #for n=500
# epoch = 150 #for n=1000
# eval_epoch=10 #for n=1000
...
data_root = "/home/ostocker/travaux/data/mixed_real_sim"
info=dict(mixed=True,intensity_max=[125,1025], dataset_usage=1)
